...
model = keras.Sequential([
    ...
    layers.Dense(5)  # Jetzt 5 Werte als Ausgabe
])
...
model_save_path = os.path.join(BASE_DIR, r"Aktienai_einen_Monat_Woche_vorhersage/Models/30_5/trained_model.h5")
...
def plot_differences(differences):
    ...
    directory = os.path.join(BASE_DIR, r"Aktien_Trainer/Lern-Fortschritt/30_5")
