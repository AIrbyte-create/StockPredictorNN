...
file_path = os.path.join(BASE_DIR, r"Aktienai_eine_Woche_vorhersage/AktienInformationDownloader/12_3/PUM.DE_prices_only_15.txt")
...
while index < len(lines):  
    ...
    # 🔄 40 Zeilen eingeben (falls noch genug übrig sind)
    for _ in range(42):
