...
hauptskript_path = os.path.join(BASE_DIR, r"Aktienai_einen_Monat_Woche_vorhersage/Models/30_5/Main_30_5_Tage.py")
...
# 🟢 Nur die letzten 12 Zahlen aus der zweiten Zeile extrahieren
