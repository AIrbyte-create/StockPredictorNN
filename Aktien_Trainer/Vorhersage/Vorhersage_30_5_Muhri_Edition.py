...
hauptskript_path = os.path.join(BASE_DIR, r"Aktienai_einen_Monat_Woche_vorhersage/Models/30_5_Muhri_Version/Main_30_5_Tage_Muhri_Version.py")
...
# 🟢 Nur die letzten 30 Zahlen aus der zweiten Zeile extrahieren
numbers = lines[1].split(",")
lines[1] = ",".join(numbers[-30:])  # Nimmt nur die letzten 30 Zahlen
